...
#### Scenario: Detecting stale structural files and documentation

- **WHEN** running `openspec update` or `openspec init`
- **THEN** the system SHALL check for and facilitate disposal of:
  - `openspec/AGENTS.md`
  - `openspec/project.md`
